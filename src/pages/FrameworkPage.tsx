    ...
    <div className="max-w-screen-xl mx-auto px-4 sm:px-6 py-10 animate-fadeIn">
      ...
      <div className="mb-10">
        ...
        <p className="text-slate-500 max-w-2xl leading-relaxed">
          Navegue pela estrutura completa do NIST CSF 2.0, seis Funções, dezessete Categories e cento e seis Subcategories organizadas por resultados de cibersegurança.
        </p>
      </div>

      <PageIntro
        title="O que é o CSF Core?"
        plain="O Core é o coração do NIST CSF, uma lista de resultados de cibersegurança organizados em 6 Funções, 17 Categorias e 106 Subcategorias."
